...
std::unique_ptr<IResource> FactoryResource::createResource(IResource::resourceType type, const Vector3 &position, const ResourceManager &manager, int id) {
    static const std::unordered_map<IResource::resourceType, std::function<std::unique_ptr<IResource>(const Vector3 &, const ResourceManager &, int)>> componentMap {
        {IResource::resourceType::BURGER, [](const Vector3 &position, const ResourceManager &manager, __attribute__((unused)) int id)
        ...
        {IResource::resourceType::LINEMATE, [](const Vector3 &position, const ResourceManager &manager, __attribute__((unused)) int id)
        ...
        {IResource::resourceType::DERAUMERE, [](const Vector3 &position, const ResourceManager &manager, __attribute__((unused)) int id)
        ...
        {IResource::resourceType::SIBUR, [](const Vector3 &position, const ResourceManager &manager, __attribute__((unused)) int id)
        ...
        {IResource::resourceType::MENDIANE, [](const Vector3 &position, const ResourceManager &manager, __attribute__((unused)) int id)
        ...
        {IResource::resourceType::PHIRAS, [](const Vector3 &position, const ResourceManager &manager, __attribute__((unused)) int id)
        ...
        {IResource::resourceType::THYSTAME, [](const Vector3 &position, const ResourceManager &manager, __attribute__((unused)) int id)
        ...
        {IResource::resourceType::EGG, [](const Vector3 &position, const ResourceManager &manager, int id)
